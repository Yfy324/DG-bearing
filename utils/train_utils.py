...
class TrainUtils(object):
    ...
    def setup(self):
        ...
        train_loader, eval_loader = get_data_loader(args)
        ...
        # self.datasets = {}
        #
        # self.datasets['train'], self.datasets['val'] = Dataset(args).data_split()
        #
        ...
        #                     for x in ['train', 'val']}
        # Define the model
        self.model = getattr(mymodels, args.model_name)(in_channel=Dataset.inputchannel, out_channel=Dataset.num_classes)
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, args.max_epoch):
            ...
            for phase in ['train', 'val']:
                ...
                # save the model
                if phase == 'val':
                    # save the logs for other learning
