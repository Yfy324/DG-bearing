...
def parse_args():
    ...
    parser.add_argument("--iteration_size", type=int, default=700,
    ...
    parser.add_argument("--heldout_p", type=float, default=10,
                        help='learning rate of the heldout function')
    parser.add_argument("--omega", type=float, default=5e-4,
