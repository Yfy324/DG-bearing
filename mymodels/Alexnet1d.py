...
def alexnet(pretrained=False, **kwargs):
    ...
    if pretrained:  # 过滤、更新pretrain中需要的参数
        pretrained_dict = model_zoo.load_url(model_urls['alexnet'])  # 通过给定url下载网络模型的结构参数

        model_dict = model.state_dict()  # 存放训练过程中需要学习的权重和偏执系数
